...
def set_params(command_line_args, create_files=True):
    ...
    from PonyGE2.src.utilities.algorithm.initialise_run import initialise_run_params
    from PonyGE2.src.utilities.algorithm.initialise_run import set_param_imports
    ...
    from PonyGE2.src.utilities.stats import trackers, clean_stats
...
#        clean_stats.clean_stats() #retirar quando fazer gridSearch
